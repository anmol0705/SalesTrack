...
- [Migrate to expo-media-library/next](https://docs.expo.dev/guides/sdk-libraries-migration/media-library): Migrate from the legacy expo-media-library API to the new class-based expo-media-library/next API with Asset, Album, and Query.
- [Migrate to expo-calendar/next](https://docs.expo.dev/guides/sdk-libraries-migration/calendar): Migrate from the legacy expo-calendar API to the new class-based expo-calendar/next API with ExpoCalendar, ExpoCalendarEvent, and hooks.
- [Migrate to expo-contacts/next](https://docs.expo.dev/guides/sdk-libraries-migration/contacts): Migrate from the legacy expo-contacts API to the new class-based expo-contacts/next API.
