---
name: shadcn
description: Deep shadcn/ui knowledge — use when building or modifying UI components, forms, layouts, or theming in the SalesTrack dashboard. Auto-invoke when working with shadcn components, Tailwind CSS v4, Radix UI primitives, or when adding UI to apps/dashboard.
---
...
- [Skills](https://ui.shadcn.com/docs/skills): Deep shadcn/ui knowledge for AI assistants like Codex.
